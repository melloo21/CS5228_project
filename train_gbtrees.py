...
### Parameter grid for GBTrees ###
param_grid = {
    'learning_rate': [0.02, 0.05, 0.1],
    'max_depth': [3, 5, 7, 10],
    'n_estimators': [500, 1000, 1500],
    'subsample': [0.6, 0.8, 1.0],  # Similar to bagging_fraction
    'max_features': [0.6, 0.8, 1.0],  # Similar to feature_fraction
}
...
if save_model:
    ...
    pickle.dump(best_xgb, open(rf"C:/Users/kan_h/Desktop/Kan Hon/Admin/NUS MComp/AY2425_Sem1/CS5228/cs5228-project/CS5228_project/model_assets/gbtrees_{name}.pkl", "wb"))
