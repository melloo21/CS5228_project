...
def fuel_type_imputer(train_df, val_df, test_df):
    ...
    train_df[variable] = imputer.fit_transform(train_df[[variable]])
    val_df[variable] imputer.transform(val_df[[variable]])
    test_df[variable] = imputer.transform(test_df[[variable]])
